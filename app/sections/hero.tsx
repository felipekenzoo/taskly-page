...
export default function Hero() {
  return (
    <section className="bg-neutral-50 pt-32 flex flex-col items-center justify-center px-6 md:px-12 lg:px-28 lg:pt-48">
      <Hat icon={<Sparkles size={20} />} title="Agora com IA integrada!" />
